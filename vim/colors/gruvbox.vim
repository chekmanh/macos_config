...
if has("spell")
  ...
  if g:gruvbox_improved_warnings == 0
    ...
    call s:HL('SpellCap',   s:green, s:none, s:undercurl . s:italic)
  endif
  " Not recognized word
  call s:HL('SpellBad',   s:red, s:none, s:undercurl, s:blue)
  " Wrong spelling for selected region
  call s:HL('SpellLocal', s:red, s:none, s:undercurl, s:aqua)
  " Rare word
  call s:HL('SpellRare',  s:red, s:none, s:undercurl, s:purple)
endif
